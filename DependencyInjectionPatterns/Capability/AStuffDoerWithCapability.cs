namespace DependencyInjectionPatterns.Capability
{
    ...
    /// <summary>
    /// An implementation of IDoStuffWithCapability
    /// </summary>
    class AStuffDoerWithCapability : IDoStuffWithCapability
    {
        ...
        /// </summary>
        public AStuffDoerWithCapability(Func<int, bool> canHandleFunction)
        {
